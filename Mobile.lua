...
LOGO.Image = "rbxassetid://16654541758"
...
loki.Image = "rbxassetid://16654541758"
...
ImageLabel.Image = "rbxassetid://16654541758"
...
--------------------------------------------------------------------
local Library = Update:Window("ZAIRE HUB","16654541758")
--------------------------------------------------------------------
...
--------------------------------------------------------------------
Update:Notification("Hello, " ..game.Players.LocalPlayer.DisplayName.. " Welcome To ZAIRE HUB Mobile! Enjoy Using it! ")
...
Setting:Toggle("Fast Attack [NORMAL]",false,function(t)
    _G.FastAttack2 = t
end)

    Setting:Toggle("Fast Attack [EXTRA]",true,function(Fast)
        _G.FastAttack = Fast
        end)
...
Setting:Toggle("Bring Mob [Extra]",false,function(Mag)
    _G.BringMonster = Mag
    end)
    spawn(function()
        while task.wait() do
...
Main:Toggle("Farm Level",_G.AutoFarm,function(value)
        _G.AutoFarm = value
        StopTween(_G.AutoFarm)
end)

Main:Toggle("Farm Bone",_G.AutoFarmBone,function(value)
					...
					if game.Players.LocalPlayer.Backpack:FindFirstChild("God's Chalice") or game.Players.LocalPlayer.Character:FindFirstChild("God's Chalice") then
						if string.find(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SweetChaliceNpc"),"Where") then
							game.StarterGui:SetCore("SendNotification", {
								...
								Icon = "http://www.roblox.com/asset/?id=16654541758",
								Duration = 2.5
							})
						else
...
Main:Button("Mink Fake Transform",function()
    require(game:GetService("ReplicatedStorage").Notification).new("Mink V4! / By : ZAIRE HUB"):Display();
    wait()
    setthreadcontext(5)
    ...
    require(game:GetService("ReplicatedStorage").Notification).new("Fishman V4! / By : ZAIRE HUB"):Display();
    wait()
    setthreadcontext(5)
    ...
    require(game:GetService("ReplicatedStorage").Notification).new("Skypeian V4! / By : ZAIRE HUB"):Display();
    wait()
    setthreadcontext(5)
    ...
    require(game:GetService("ReplicatedStorage").Notification).new("Ghoul V4! / By : ZAIRE HUB"):Display();
    wait()
    setthreadcontext(5)
    ...
    require(game:GetService("ReplicatedStorage").Notification).new("Cyborg V4! / By : ZAIRE HUB"):Display();
    wait()
    setthreadcontext(5)
    ...
    require(game:GetService("ReplicatedStorage").Notification).new("Human V4! / By : ZAIRE HUB"):Display();
    wait()
    setthreadcontext(5)
